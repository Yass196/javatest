...
class ListsTests {
    ...
    void init() {
        ...
        liste3 = Arrays.asList(18, 93, 22, 74, 30, 21, 2, 72, 11, 57, 0);
    }
    ...
    void partitionTest() throws Exception {
        ...
        List<List> resultListe1_2 = Arrays.asList(Arrays.asList(1, 8, 9),
                Arrays.asList(12, 3, 10));
        List<List> resultListe1_3 = Arrays.asList(Arrays.asList(1, 8, 9, 12),
                Arrays.asList(3, 10));
        List<List> resultListe2_1 = Arrays.asList(Arrays.asList(12, 81),
                Arrays.asList(4, 5),
                Arrays.asList(31, 17),
                Arrays.asList(99));
        List<List> resultListe2_2 = Arrays.asList(Arrays.asList(12, 81, 4),
                Arrays.asList(5, 31, 17),
                Arrays.asList(99));
        List<List> resultListe2_3 = Arrays.asList(Arrays.asList(12, 81, 4, 5),
                Arrays.asList(31, 17, 99));
        List<List> resultListe3_1 = Arrays.asList(Arrays.asList(18, 93),
                Arrays.asList(22, 74),
                Arrays.asList(30, 21),
                Arrays.asList(2, 72),
                Arrays.asList(11, 57),
                Arrays.asList(0));
        List<List> resultListe3_2 = Arrays.asList(Arrays.asList(18, 93, 22),
                Arrays.asList(74, 30, 21),
                Arrays.asList(2, 72, 11),
                Arrays.asList(57, 0));
        List<List> resultListe3_3 = Arrays.asList(Arrays.asList(18, 93, 22, 74, 30),
                Arrays.asList(21, 2, 72, 11, 57),
                Arrays.asList(0));
    ...
    Assertions.assertEquals(exception1.getMessage(), Lists.SMALLLISTERROR);
    Assertions.assertEquals(exception2.getMessage(), Lists.NULLSIZEVALUE);
    Assertions.assertEquals(exception3.getMessage(), Lists.EMPTYLISTERROR);
